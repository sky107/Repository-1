...
import classes from './RejectedOfferPage.module.css';
        ...
        >
          <div style={{ display: "flex" }}>
            {["Received Offers", "Accepted Offers", "Rejected Offer"].map(
              (x, i) => (
                <div
                  className={classes[`tab-titles${i === 2 ? "-active" : ""}`]}
            ...
            {[1, 2, 3, 4, 5, 6, 7, 8].map(() => (
              <div className={classes.card}>
                ...
                <div className={classes["card-title"]}>
                  ...
                  <div style={{ fontWeight: 600 }}>Status:Rejected on 24Jun <br/> Feedback: sdklfjdksldjfdsklfjdslkfjklfsjsf... <br/></div>
